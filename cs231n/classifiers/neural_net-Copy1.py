...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        hiddenLayerOutput = np.maximum(hiddenLayer, 0) #ReLu activation function
        
        scores = np.dot(hiddenLayerOutput, W2) + b2
        ...
        #Guarantee all scores to be negative
#        scores -= np.max(scores)
        #Calculate de probability of each score
...
#        loss += reg * (np.sum(W1*W1) + np.sum(W2*W2))
        ...
        #correct_probs = np.choose(y, probabilities.T) # (N, 1)
...
#        dscores /= N
        ...
        #Backpropagation da saída para camada escondida
        #Está calculando o quanto atualizar os pesos de acordo com o quanto cada um influencia no erro da saída
...
#        grads['W2'] += reg * W2
        ...
        out1[hiddenLayer <= 0] = 0
        grads['W2'] = np.dot(hiddenLayerOutput.T,probabilities) + reg * W2
        ...
        #dhidden = dscores.dot(W2.T)
        #dhidden[hidden_layer <= 0] = 0
        #backpropagation da camada escondida para entrada
        #Está calculando o quanto atualizar os pesos de acordo com o quanto cada um influencia no erro da saída
        #grads['W1'] = X.T.dot(dhidden)
        #grads['b1'] = np.sum(dhidden,axis=0)
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            #    self.params[l] = -= learning_rate*grads[l]
